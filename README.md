...
2.  **Deploy the Web Service**:
    ...
    * Start the web service container:
        ...
        ```
    [!NOTE] 
    If you need to make changes to the containers, you need to rebuild the images for the chaneges to be depoyed. After changing the files restart the containers with `sudo docker compose up --force-recreate --build -d`
