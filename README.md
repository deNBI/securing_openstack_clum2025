...
| [Caddy](https://caddyserver.com/) | An open-source web server with powerful reverse proxy capabilities. We'll use it for its built-in automation of HTTPS certificate provisioning via Let's Encrypt. Caddy simplifies SSL/TLS encryption, making it easy to secure web traffic. |
...
* **Network:** `CLUM2025SecWeb1-reverseproxy-network`
...
- To see the ports the vm listens on use:
`ss -tulpan`
